...
const CardStatsVertical = props => {
  ...
  return (
    <Card>
      <CardContent>
        <Box sx={{ display: 'flex', marginBottom: 5.5, alignItems: 'flex-start', justifyContent: 'center' }}>
          <IconButton size='small' aria-label='settings' className='card-more-options' sx={{ color: 'text.secondary' }}>
          <Avatar size='large' sx={{ boxShadow: 3, marginRight: 0, color: 'common.white', backgroundColor: `${color}.main` }}>
            {icon}
          </Avatar>
          </IconButton>
        </Box>  
